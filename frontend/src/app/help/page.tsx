              ...
              <div className="px-5 sm:px-6 pt-5 pb-4">
                ...
                <div className="mt-4 space-y-3 text-sm text-red-950/90">
                  ...
                  <div className="rounded-xl bg-[#fff7ee] ring-1 ring-yellow-300/60 p-4">
                    <p className="font-semibold text-red-900">Login</p>
                    <p className="mt-1">
                      Use your authorized university account to access the system.
                    </p>
                  </div>

                  <div className="rounded-xl bg-[#fff7ee] ring-1 ring-yellow-300/60 p-4">
                    <p className="font-semibold text-red-900">Managing Indicators</p>
                    <p className="mt-1">
                      You can add, update, delete, or view performance indicators
                      through the dashboard.
                    </p>
                  </div>

                  <div className="rounded-xl bg-[#fff7ee] ring-1 ring-yellow-300/60 p-4">
                    <p className="font-semibold text-red-900">Need Assistance?</p>
                    <p className="mt-1">
                      Contact the system administrator if you encounter issues.
                    </p>
                  </div>
